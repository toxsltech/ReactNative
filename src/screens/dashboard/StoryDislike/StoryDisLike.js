...
class StoryDisLike extends Component {

  render() {

    const followersData = this.props.getstorydislikeResponse.data
    ...
    return (
      <Container style={{ flex: 1 }}>
        <AppHeader
          ...
          body={
            <ResponsiveText style={styles.headertitle}>DisLiked By</ResponsiveText>
          }
